...
public class LegendaryBlockEntities {
	...
	public static final BlockEntityType<LegendaryPedestalBlockEntity> LEGENDARY_PEDESTAL_ENTITY =
		BlockEntityType.Builder.create(
			LegendaryPedestalBlockEntity::new,
			LegendaryBlocks.LEGENDARY_PEDESTAL
		).build(null);
